...
<body>
   <!-- topBar와 header -->
    ...
    <section class="fullPage">
        <div class="login">
            <div class="login_top"> 
                <img class="login_logo" src="../resource/img/jeiu_login_logo.png" alt="로그인 이미지"><a class="login_logo_name">인천재능대학교</a>
                
            </div>
            <form class="loginForm" action="../web_control.jsp" method="POST">
