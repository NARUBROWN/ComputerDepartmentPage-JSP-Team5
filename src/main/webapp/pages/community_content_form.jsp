	...
	<section class="notice_table">
        ...
        <input type="hidden" name="action" value="commnuity-insert">
            <ul>
                <li class="font_head">
                    <span>제목</span>
                    <span><input type="text" name="co_title"></span>
                </li>
				<li>
					<!-- 이용자 ID 처리 -->
					<input type="hidden" name="co_author" value="<%=user%>">
				</li>
                <li class="notice_content">
                    <span>내용</span>
                    <span><textarea name="co_content"></textarea></span>
                </li>
                <li>
                	<!-- 오늘 날짜 처리 -->
                	<input type="hidden" name="co_date" value="<%=strdate%>">
                </li>
            </ul>
