     ...
     <!-- 절대경로 (${pageContext.request.contextPath}, webapp 안에서 시작) -->
        ...
        <div class="dropNavBackgroundMain">
            ...
            <div class="dropNavBackground4" id="dropdownNav4">
                <ul>
                    <li>
                        <a href="${pageContext.request.contextPath}/pages/list.jsp?type=notice">공지사항 게시판 관리</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/pages/list.jsp?type=community">커뮤니티 게시판 관리</a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/pages/list.jsp?type=member">회원 관리</a>
                    </li>
                </ul>
            </div>
        </div>